...
class MainActivity : ComponentActivity() {
        ...
        setContent {
            GestionnaireDeTâchesTheme {
                    ...
                    Surface ( modifier = Modifier.fillMaxSize(),
                        ...
                        GestionnaireDeTachesImage (

                             titre = stringResource(R.string.all_tasks_completed),
    ...
    @Composable
    fun GestionnaireDeTachesImage( titre: String, message: String, modifier: Modifier = Modifier) {
